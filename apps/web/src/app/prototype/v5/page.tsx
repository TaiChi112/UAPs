...
export default function ResumeApp() {
  ...
  const [currentView, setCurrentView] = useState<
    "dashboard" | "builder_manual" | "builder_ai"
  >("dashboard");
  ...
  const handleAnalyzeJD = () => {
    ...
    setTimeout(() => {
      ...
      const suggestedConfig = {
        ...
        summary:
          "Data Engineer with expertise in Python and AWS, aiming to optimize data pipelines as required in the Job Description.", // AI Rewritten summary
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-indigo-700/70 mt-1">
                    Paste a Job Description. Let AI scan your vault and build
                    the perfect match.
                  </p>
                </div>
              </div>
            ...
            <div className="relative w-full max-w-5xl h-full flex flex-col bg-slate-100 rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
              <div className="bg-white px-6 py-4 border-b flex justify-between items-center sticky top-0 z-10 shadow-sm">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    onClick={() => setToastMessage("Downloading PDF...")}
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden flex flex-col h-full">
            <div className="bg-slate-50 border-b border-slate-200 p-4 flex justify-between items-center">
              <div>
                ...
                <h2 className="text-xl font-bold text-slate-800">
                  {editingId ? "Edit Resume" : "Manual Builder"}
                </h2>
              </div>
              <button
                ...
                <section className="space-y-3">
                  ...
                  {db.experience.map((exp) => (
                    ...
                    >
                      <input
                        type="checkbox"
                        checked={resumeConfig.selectedExperience.includes(
                          exp.id,
                        )}
                        onChange={() =>
                  ...
                  {db.certificates.map((cert) => (
                    ...
                    >
                      <input
                        ...
                        onChange={() =>
                          toggleSelection("selectedCerts", cert.id)
                        }
                        className="mt-1 accent-blue-600"
                      />
                      <div className="font-medium text-slate-800 group-hover:text-blue-600 transition-colors">
      ...
      <div className="min-h-screen bg-slate-50 text-slate-800 p-4 md:p-6 font-sans">
        ...
        <div className="max-w-7xl mx-auto mb-6 flex justify-between items-center">
          ...
          {aiAnalysisState === "done" && (
            <div className="flex gap-3">
              <button
                onClick={() => setCurrentView("builder_manual")}
            ...
            {aiAnalysisState === "idle" && (
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col h-full">
                <div className="mb-4">
                  ...
                  <p className="text-sm text-slate-500 mt-1">
                    AI will match your vault data and rewrite your summary to
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 overflow-y-auto">
                <div className="flex justify-between items-center mb-6 pb-4 border-b">
                  <div>
                    <h2 className="font-bold text-slate-900 flex items-center gap-2">
                      <Sparkles className="w-4 h-4 text-indigo-600" /> AI
                      Insights
                    </h2>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 text-sm text-slate-600">
                    <strong>Note:</strong> The AI has automatically rewritten
                    your Executive Summary and selected relevant projects/skills
                    to match the JD.
                  </div>
                </div>
              </div>
