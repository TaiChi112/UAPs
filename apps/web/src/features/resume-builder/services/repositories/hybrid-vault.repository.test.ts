...
const createFallbackRepository = (): VaultRepository => ({
  ...
  updateSkill: async () => ({} as never),
  deleteSkill: async () => true,
  createExperience: async () => ({} as never),
  updateExperience: async () => ({} as never),
  deleteExperience: async () => true,
  createCertificate: async () => ({} as never),
  updateCertificate: async () => ({} as never),
  deleteCertificate: async () => true,
  createAward: async () => ({} as never),
  updateAward: async () => ({} as never),
  deleteAward: async () => true,
  duplicateResume: async () => null,
  updateResumeVisibility: async () => null,
  getPublicResumes: async () => [],
